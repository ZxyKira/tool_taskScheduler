...
//  Typedef 
//------------------------------------- 
typedef void (*tool_ts_execute_t)(void* args);

/* *****************************************************************************************
 *  Struct tool_ts_event_t
 */
typedef struct _tool_ts_event_t{
  tool_ts_execute_t execute;
  void*  attachment;
}tool_ts_event_t;
...
typedef struct _tool_ts_api_t{
  ...
  bool(*execute)      (tool_ts_handle_t *handle);
  bool(*breakExecute) (tool_ts_handle_t *handle);
  bool(*addTask)      (tool_ts_handle_t *handle, tool_ts_execute_t execute, void* attachment, tool_ts_prtority prtority);
  bool(*addTaskSuper) (tool_ts_handle_t *handle, tool_ts_execute_t execute, void* attachment, tool_ts_prtority prtority);  
}tool_ts_api_t;
